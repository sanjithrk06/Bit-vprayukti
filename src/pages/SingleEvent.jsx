      ...
      >
        <div className="container max-w-6xl mx-auto px-5 md:px-2 text-center">
          ...
          >
            ...
            <Link to={"/tickets1"} class="max-w-[300px] px-6 py-2 mt-8 bg-dimBlue border-2 border-accent rounded-full items-center text-indigo-100 lg:rounded-full flex lg:inline-flex">
