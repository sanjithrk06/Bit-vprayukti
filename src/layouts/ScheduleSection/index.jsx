      ...
      <div className="container max-w-6xl text-center mx-auto px-5 md:px-2">
        ...
        <h2
          ...
          {/* <div
            data-aos="fade-up" data-aos-offset="10"
            data-aos-once="true"  data-aos-delay="0"
            class=" items-center border-[3px] border-dimWhite bg-primary  bg-clip-padding backdrop-filter backdrop-blur-lg bg-opacity-[0.5] rounded-3xl select-none nav-tabs flex justify-center w-full md:w-[600px] mx-auto mb-16 mt-10"
          >
            <ul
